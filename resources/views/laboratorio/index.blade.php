...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #0ea5e9 0%, #10b981 100%); color: white; padding: 1rem 1.25rem;">
            <h3 class="card-title mb-0" style="font-weight: 600;">
                <i class="fas fa-flask mr-2"></i> Listado de Resultados
            </h3>
            <a href="{{ route('laboratorio.create') }}" 
               ...
               onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 12px rgba(0, 0, 0, 0.15)'; this.style.color='#0ea5e9';">
                <i class="fas fa-plus-circle mr-2"></i> Nuevo Resultado
            </a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('laboratorio.show', $resultado) }}" 
            ...
            <div class="text-center py-5">
                ...
                <a href="{{ route('laboratorio.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Registrar Primer Resultado
                </a>
            </div>
            @endif
        </div>
