        ...
        <div class="container">
            <div class="verification-card">
                ...
                <div class="info-section">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $order->patient->fecha_nacimiento ?? 'N/A' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $order->result_date->format('d/m/Y') }}</span>
                        </div>
                        <div class="info-row">
                ...
                <div class="footer-custom">
                    ...
                    <small>Documento verificado el {{ now()->format('d/m/Y H:i:s') }}</small>
                </div>
            </div>
        </div>
    </div>
