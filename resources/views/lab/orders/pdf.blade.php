...
<body>
    ...
    <div class="header">
        <table class="header-table">
            <tr>
                <td width="20%">
                    <img src="{{ public_path('images/logo.png') }}" class="logo" onerror="this.style.display='none'">
                </td>
    ...
    <div class="patient-info">
        <table>
            <tr>
                ...
                <td width="25%">{{ $order->order_date->format('d/m/Y') }}</td>
            </tr>
            <tr>
    ...
    <div class="footer">
        ...
        <div style="clear: both; margin-top: 20px;">
            <p>Este informe ha sido validado electrónicamente. Código de Verificación: <strong>{{ $order->verification_code }}</strong></p>
            <p>Impreso por: {{ Auth::user()->name }} | Fecha: {{ now()->format('d/m/Y h:i A') }}</p>
        </div>
    </div>
</body>
</html>
